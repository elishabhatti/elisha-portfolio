...
function SelectTrigger({ className, size = "default", children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-[48px] w-full items-center justify-between rounded-md border border-white/10 bg-black px-4 py-5 text-base text-white/60 placeholder:text-white/10 focus:border-[#a238ff] outline-none",
        className
      )}
      {...props}
    >
